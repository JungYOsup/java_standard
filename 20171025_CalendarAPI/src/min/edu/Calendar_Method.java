...
public class Calendar_Method {
	...
	public void print(int year , int month) {//2017 1
		...
		int beforeDay = gCal.getActualMaximum(Calendar.DAY_OF_MONTH)-dayOfWeek+1;     /*beforeDays(year, month)-dayOfWeek+1;*/ // 30 - 
		
		for (int i = beforeDay; i <=gCal.getActualMaximum(Calendar.DAY_OF_MONTH); i++) 
		{
